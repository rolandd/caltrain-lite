 ...
 */
export async function initSchedule(onUpdate?: (schedule: StaticSchedule) => void): Promise<StaticSchedule> {
 ...
 */
async function checkForUpdate(currentVersion: string, onUpdate?: (schedule: StaticSchedule) => void) {
