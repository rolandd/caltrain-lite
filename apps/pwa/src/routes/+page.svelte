    ...
    >
      <div class="flex items-center gap-2 mb-4 max-[480px]:flex-col max-[480px]:items-stretch">
        <div class="flex-1 flex items-center gap-3">
          ...
          <select
            id="origin"
            class="bg-transit-surface-input border border-transit-border-subtle rounded-[10px] text-transit-text-primary text-base p-3 w-full flex-1 min-w-0 focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none"
            bind:value={origin}
            onchange={search}
          >
        ...
        <button
          class="w-11 h-11 bg-transit-surface-elevated border border-transit-border-subtle rounded-[10px] text-transit-brand text-xl cursor-pointer flex-shrink-0 self-center hidden max-[480px]:flex items-center justify-center focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none"
          onclick={swap}
        ...
        <button
          class="w-8 h-8 bg-transparent border-none text-transit-brand text-xl cursor-pointer flex-shrink-0 self-center max-[480px]:hidden hover:text-transit-text-primary transition-colors focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none rounded-[4px]"
          onclick={swap}
          aria-label="Swap stations"
          title="Swap stations"
          disabled={!origin && !destination}
      ...
      <div class="flex items-end gap-2 max-[480px]:flex-col max-[480px]:items-stretch">
        <div class="flex-1 flex items-center gap-3">
          ...
          <div class="flex items-center gap-1 flex-1 min-w-0">
            <button
              class="w-11 h-11 bg-transit-surface-input hover:bg-transit-surface-hover-soft border border-transit-border-subtle rounded-[10px] text-transit-text-primary text-base cursor-pointer flex items-center justify-center flex-shrink-0 transition-colors focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none"
              onclick={prevDay}
            ...
            <input
              id="date"
              class="h-11 bg-transit-surface-input border border-transit-border-subtle rounded-[10px] text-transit-text-primary text-base px-2 w-full min-w-0 text-center uppercase focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none"
              type="date"
              bind:value={dateStr}
        ...
        <div class="flex items-center gap-2 max-[480px]:w-full">
          <button
            class="h-11 px-3 bg-transparent hover:bg-transit-surface-hover-soft border border-transit-border-subtle rounded-[10px] text-transit-brand text-sm font-semibold cursor-pointer flex items-center justify-center gap-1.5 flex-1 transition-colors focus-visible:ring-2 focus-visible:ring-transit-brand focus-visible:outline-none"
            onclick={goNow}
